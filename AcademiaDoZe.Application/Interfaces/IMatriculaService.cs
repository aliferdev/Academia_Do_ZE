...
public interface IMatriculaService
{
    ...
    /// <summary>
    /// Cadastra uma nova matrícula para o aluno.
    /// </summary>
    ...
    /// </summary>
    Task<IEnumerable<MatriculaDto>> ObterPorAlunoIdAsync(
        int alunoId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<MatriculaDto?> ObterMatriculaAtivaPorAlunoAsync(
        int alunoId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<bool> PossuiMatriculaAtivaAsync(
        int alunoId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<MatriculaDto>> ObterAtivasAsync(
        int alunoId = 0,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<MatriculaDto>> ObterVencendoEmDiasAsync(
        int dias,
        CancellationToken cancellationToken = default);

    /// <summary>
    /// Obtém matrículas filtrando pelo tipo de plano contratado.
    /// </summary>
    Task<IEnumerable<MatriculaDto>> ObterPorPlanoAsync(
