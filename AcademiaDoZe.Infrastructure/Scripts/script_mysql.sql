CREATE TABLE IF NOT EXISTS tb_logradouro (
    ...
    UNIQUE KEY uk_tb_logradouro_cep (cep),
...
CREATE TABLE IF NOT EXISTS tb_aluno (
    ...
    UNIQUE KEY uk_tb_aluno_cpf (cpf),
    CONSTRAINT fk_tb_aluno_logradouro FOREIGN KEY (logradouro_id) REFERENCES tb_logradouro(id_logradouro) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS tb_colaborador (
    ...
    UNIQUE KEY uk_tb_colaborador_cpf (cpf),
    CONSTRAINT fk_tb_colaborador_logradouro FOREIGN KEY (logradouro_id) REFERENCES tb_logradouro(id_logradouro) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS tb_matricula (
    ...
    laudo_medico MEDIUMBLOB NULL,
    PRIMARY KEY (id_matricula),
    INDEX ix_tb_matricula_aluno_id (aluno_id),
    INDEX ix_tb_matricula_data_fim (data_fim),
    CONSTRAINT fk_tb_matricula_aluno FOREIGN KEY (aluno_id) REFERENCES tb_aluno(id_aluno) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB;
