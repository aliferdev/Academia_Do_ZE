...
BEGIN
    CREATE TABLE tb_aluno (
        ...
        CONSTRAINT FK_tb_aluno_logradouro FOREIGN KEY (logradouro_id) REFERENCES tb_logradouro(id_logradouro)
    );
END;
...
BEGIN
    CREATE TABLE tb_colaborador (
        ...
        CONSTRAINT FK_tb_colaborador_logradouro FOREIGN KEY (logradouro_id) REFERENCES tb_logradouro(id_logradouro)
    );
END;
...
BEGIN
    CREATE TABLE tb_matricula (
        ...
        CONSTRAINT FK_tb_matricula_aluno FOREIGN KEY (aluno_id) REFERENCES tb_aluno(id_aluno)
    );
