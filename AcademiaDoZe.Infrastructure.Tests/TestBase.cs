...
public abstract class TestBase
{
    ...
    protected TestBase()
    {
        ...
        {
            DatabaseType.SqlServer => "Server=localhost, 1433;Database=db_academia_do_ze;User Id=sa;Password=abcBolinhas12345;TrustServerCertificate=True;Encrypt=False;",
            DatabaseType.MySql => "Server=localhost;Port=3307;Database=db_academia_do_ze;User Id=root;Password=abcBolinhas12345;SslMode=None;AllowPublicKeyRetrieval=True;",
